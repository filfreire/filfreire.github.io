...
But I for one am going to hold my feelings for a moment, and dissect a bit what this might mean, and I'll be doing it keeping in mind:
- __The people__ who have respect and love for the Testing craft, unlike the ISTQB as an abstract group (and I'm willing to grant, not necessarily some its individuals, since I know quite a few of them who love and respect Testing);
...
It's undeniable that, from a "buzz-word" standpoint, indeed Software Testing seemingly has been moving more towards "Automation". The common _industry accepted_ understanding is that there is such a thing as Manual Testing, and the paired industrial understanding that where you see the word "Manual", there's bound to be a machine that can do it better. And in this sense, there's no mute button for reality, and the reality is: News tools. New software libraries. AI advertising of "it'll do it for us". New ways of representing a view in an object. New ways to call an API or publish a message in the context of a scenario that will assert something in the end. New ways of organizing "testing" code. etc. Even personally, it's undeniable: I spend a portion of my working day coding, using tools, and maintaining scripts, and I am a Tester.

The horse dropping part is when you confront the "buzz" with different abstractions of the whole Testing phenomenon, and in its truest form when simply put: __Testing is undeniably humane.__ There's simply no way around it.
...
This has been happening now for maybe almost two decades, and people left and right have come forth on plenty of occasions saying both "true-ish and horse dropping" _words of ~~dis~~order_: "Test is Dead", "Automation Testing is the future", "Bots will replace human testers", "Agile testing is a thing", "The death of manual testing is NOW", "Let's all get along, testers are cheerleaders", ...
...
- No, you can't automate testing. Testing is not only "logical checking";
...
The problem is this stuff is advertised as "the next step", one to replace Testers in practice.
...
> "I worked at EvilCorp for 5 years as Omega Director of Testing & Quality" (Yup, Mr. Robot ref.)

to sell "air in a jar" software, directly mocking Testers, that I can't stand.

#### Opening the "air jar software"

I invest some of my free time hacking away at any piece of software I can get my hands on. One of those sessions last year was spent hacking away at one of these "Automated AI Testing" services. After some time tinkering around I was able to hop into their Admin panel, create accounts with admin permissions, spam the service with crap data, and do a couple more mischevious stuff. Suffice it to say:
- No it didn't seem to work as advertised, it didn't replace me as a Tester, and it didn't even replace the most stupid opensource static analysis or code quality tool out there;
...
As an extra point, and none of these companies will probably do this in the next 10 or more years, because guess what, people like money, if there's a service that advertisedly "tests" my build artifacts, the only feasible way I see of remotely adopting this as a helper stage in my CI pipelines is if I have full open access to what exactly that service does, and the "if-else" chains in the scripts it's made of (advertised as AI). And by open access, I mean also opensource access to its code. Why? Two reasons:

__1. Evidence of testing.__

It's as simple as this: as a Tester or a Test Manager I expect myself or any of my Testers to produce and convey evidence of their Testing. I want to understand at any stage in a clear and humane way (and no, I'm not talking about some shallow test-case counts, percentages, graphs, push notifications, ...) what was tested, how was it tested, what was left out, which automated checks are in the scene, what was confusing, what wasn't looked at, what are the main risks for different actors (example: whats important for say, a regular coder, is not necessarily important for a sales rep, and vice versa...), and many more.

__2. Power to the people.__
Yeah I'm going that way. Sure, GOOD Testing is expensive. But it is also my belief Testing is "free", and I mean it as "free" as in "freedom" (not necessarily as in "free beer"). Knowledge surrounding testing and other topics should not be contained behind a corporate or academic veil. It should be free and available for the thirsty. Building a monopoly and then charging money for infrastructure plus some obfuscated service that has scripts that perform some automated checks on your build artifact is as sketchy as selling licenses (plus infrastructure) for "load testing tools", when there's plenty of open tools that work better in all cases, it's just that there's lazyness involved in the infrastructure part, and excuses start popping up.
...
I'm a portuguese, so I'm a [certified Towels salesperson, right](https://filfreire.com/posts/towels_certification)?
...
And for the record, I'm not saying "s-moke" Towels will 100% certain be the future... but I predict they will.

So don't forget: In practice no one else is acceptable in the eyes of God or Nature to "validate" and "assure" your Towel selling skills. So you better take my ~~expensive~~ affordable trainings or you'll be out of a job once the _"s-moke"_ Towel technologies reign.

Ufff.

Not implying anything... but you get what I mean, how this all looks for any layman in the end?
...
_"People don't forget, nothing gets forgiven"_ would a character say in RDR.
